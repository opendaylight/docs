...
# append_odl_latest=$(echo "$odl_latest_line_value" | sed "s/latest/$odl_release_str/g; s/$next_release_name/$release_name/g" )
...
# then
#         git add .
#         git commit -s -m "Update docs/conf.py ,docs/conf.yaml and docs/javadoc.rst in master branch
