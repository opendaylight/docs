...
== Content
 User's Guide: Instructions for installing UNI Manager plug-in

== UNI Manager Plug-In User's Guide
=== Overview
...
2. Launch karaf
    From the distribution directory, initiate the following steps from the
