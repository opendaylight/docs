...
include::groupbasedpolicy/odl-groupbasedpolicy-base-user-guide.adoc[GBP]

include::groupbasedpolicy/odl-groupbasedpolicy-ofoverlay-user-guide.adoc[GBP]

include::groupbasedpolicy/odl-groupbasedpolicy-neutronmapper-user-guide.adoc[GBP]

include::groupbasedpolicy/odl-groupbasedpolicy-opflex-user-guide.adoc[GBP]
