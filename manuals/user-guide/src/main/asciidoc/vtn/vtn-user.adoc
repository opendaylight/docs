...
include::VTN_Installation.adoc[VTN Installation Guide]

include::VTN_OpenStack_Support_User_Guide.adoc[How to set up OpenStack for the integration with VTN Manager]
