...
.DLUX Login
image::vtn/Dlux_login.png[DLUX GUI,width=600]
...
In the diagram, blue boxes represent the switches,black represents the hosts available, and lines represents how switches are connected.
...
.Network Topology
image::vtn/Dlux_topology.png[Network Topology,width=600]
