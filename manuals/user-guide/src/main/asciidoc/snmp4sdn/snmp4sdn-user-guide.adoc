...
* Change the periodic topology discovery interval
...
* To trigger SNMP4SDN Plugin to do topology discover, as described in afformentioned 'Execute topology discovery'.
