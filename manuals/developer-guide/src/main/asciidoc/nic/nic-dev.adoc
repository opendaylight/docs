...
Compile and compose list of intents

DESCRIPTION
        intent:compile

	Compile all intents and provide the results after conflict resolution
 eg: intent:compile
 eg: intent:compile --graph

SYNTAX
        intent:compile [options]
...
image::nic/MPLS_VPN_Service_Diagram.png[MPLS VPN Service Diagram, ,width= 764]
