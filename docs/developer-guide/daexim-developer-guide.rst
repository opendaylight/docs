...
The APIs are availabel via REST. The details are provided are in user-guide.


API Reference Documentation
===========================

The details of the API are also available in the YANG model for this feature. This model is accessiable via the APIDOC explorer interface.
