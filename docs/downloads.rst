...
:Downloads:
    * `OpenDaylight Fluorine Tar
      <https://nexus.opendaylight.org/content/groups/public/org/opendaylight/integration/opendaylight/0.9.0/opendaylight-0.9.0.tar.gz>`_
    * `OpenDaylight Flourine Zip
      <https://nexus.opendaylight.org/content/groups/public/org/opendaylight/integration/opendaylight/0.9.0/opendaylight-0.9.0.zip>`_
