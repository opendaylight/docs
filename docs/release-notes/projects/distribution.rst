...
`OpenDaylight JIRA Tickets - Improvement <https://jira.opendaylight.org/issues/?jql=project+%3D+distribution+AND+type+%3D+Improvement+AND+status+in+%28Resolved%2C+Done%2C+Closed%29+AND+fixVersion+in+%28%22Vanadium+GA%22%2C+Vanadium%2C+vanadium%29++ORDER+BY+issuetype+DESC%2C+key+ASC>`_
...
`OpenDaylight JIRA Tickets - New Feature <https://jira.opendaylight.org/issues/?jql=project+%3D+distribution+AND+type+%3D+%22New+Feature%22+AND+status+in+%28Resolved%2C+Done%2C+Closed%29+AND+fixVersion+in+%28%22Vanadium+GA%22%2C+Vanadium%2C+vanadium%29++ORDER+BY+issuetype+DESC%2C+key+ASC>`_
...
`OpenDaylight JIRA Tickets - Deprecated Feature <https://jira.opendaylight.org/issues/?jql=project+%3D+distribution+AND+type+%3D+Deprecate+AND+status+in+%28Resolved%2C+Done%2C+Closed%29+AND+fixVersion+in+%28%22Vanadium+GA%22%2C+Vanadium%2C+vanadium%29++ORDER+BY+issuetype+DESC%2C+key+ASC>`_
...
`OpenDaylight JIRA Tickets - Resolved Issue <https://jira.opendaylight.org/issues/?jql=project+%3D+distribution+AND+type+%3D+Bug+AND+status+in+%28Resolved%2C+Done%2C+Closed%29+AND+fixVersion+in+%28%22Vanadium+GA%22%2C+Vanadium%2C+vanadium%29++ORDER+BY+issuetype+DESC%2C+key+ASC>`_
