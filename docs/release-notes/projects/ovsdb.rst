...
* List key known issues with workarounds
  None
* `Link to Open Bugs <https://jira.opendaylight.org/issues/?jql=project%20%3D%20OVSDB%20AND%20resolution%20%3D%20Unresolved%20AND%20affectedVersion%20%3D%20Flourine%20>`_
