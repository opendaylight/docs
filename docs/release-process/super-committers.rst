...
All of the above locking and unlocking a Gerrit branch can be achieved using
a self-serviced Jenkins CI job ``autorelease-gerrit-branch-lock-${STREAM}`` by
anyone from the releng committers group.
