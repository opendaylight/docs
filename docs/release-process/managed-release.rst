...
Non-SR Projects to consume another major version update during the release.
...
checkpoints. Their midway checkpoints will be due one month before the deadline
for them to deliver their artifacts to the Managed Release Projects. Their
initial checkpoints will be due no later two weeks following the deadline for
their delivery of artifacts to the Managed Release Projects. Their initial
