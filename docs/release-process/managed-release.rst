...
* Release PM will track and allow those fixes that has not been reviewed
  or merged because of project low activity or lack of committers. The
  deadline to communicate to the Release PM the list of patches waiting
  review for a particular Service Release is the code freeze date.
