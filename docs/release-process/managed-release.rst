...
under the :ref:`initial_checkpoint` section above.  Requests should be submitted
...
in the :ref:`initial_checkpoint` section above. Requests should be submitted before
