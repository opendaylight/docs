...
Managed Release Integrated Projects will provide the releases they want the
Managed Snapshot Integrated Projects to consume no later than two weeks after
the start of the Managed Release. Managed Snapshot Integrated Projects will
decide by a majority vote of PTLs if they want to bump their versions to
consume the new releases. This should happen as early in the release as
possible to get integration woes out of the way and allow projects to focus on
developing against a stable base. If the Managed Snapshot Integrated Projects
...
temporarily wield committer rights and merge version bump patches. Managed
Snapshot Integrated Projects may decide by a PTL vote at any time to back out
of a version bump if the new releases are found to be unsuitable.

Managed Release Integrated Projects are expected to provide bugfixes via minor
or patch version updates during the release, but should strive to not expect
Managed Snapshot Integrated Projects to consume another major version update
during the release.

Managed Release Integrated Projects are free to follow their own release
cadence as they develop new features during the Managed Release. They need only
have a stable version ready for the Manged Snapshot Integrated Projects to
consume by the next integration point.

Managed Release Integrated Checkpoints
++++++++++++++++++++++++++++++++++++++

The Managed Release Integrated Projects will follow similar checkpoints as the
Managed Snapshot Integrated Projects, but the timing will be different. At the
time Managed Release Integrated Projects provide the releases they wish Managed
Snapshot Integrated Projects to consume for the next release, they will also
provide their final checkpoints. Their midway checkpoints will be scraped one
month before the deadline for them to deliver their artifacts to the Managed
Snapshot Integrated Projects. Their initial checkpoints will be due no later
two weeks following the deadline for their delivery of artifacts to the Managed
Snapshot Integrated Projects. Their initial checkpoints will cover everything
they expect to do in the next Managed Release, which may encompass any number
of major version bumps for the Managed Release Integrated Projects.
