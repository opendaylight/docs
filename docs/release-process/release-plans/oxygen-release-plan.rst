...
dates listed in the `Schedule <#Schedule1>`__ table.
...
#. Service Release Participation
   ...
   -  All projects participating in the release are also required to
      ...
      `schedule <#Schedule1>`__ after the formal release.
...
#. Testing
   ...
   -  Further details and requirements can be found in the
      `schedule <#Schedule1>`__ and `Oxygen project integration and test
...
#. Documentation
   ...
   -  More details on the expectations can be found in the
      `schedule <#Schedule1>`__ and `Oxygen project documentation
