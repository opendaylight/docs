  ...
  **(Release Engineering Team)**
  ...
  #. Publish release tags
     ...
     .. code-block:: bash
        ...
        export BUILD_NUM=55
        export OPENJDKVER="openjdk17"
        export PATCH_URL="https://s3-logs.opendaylight.org/logs/releng/vex-yul-odl-jenkins-1/autorelease-release-${STREAM,,}-mvn38-${OPENJDKVER}/${BUILD_NUM}/patches.tar.gz"
