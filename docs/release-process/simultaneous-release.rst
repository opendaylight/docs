...
- Release notes are auto generated through the job autorelease-generate-release-notes-${BRANCH,,}
  at the end of every autorelease build and the release notes file (release_notes.rst) is
  uploaded onto nexus repository. As an alternative, release notes can also be manually generated with the script.
  **(Release Engineering Team)**
  ...
  The output file generated by the build script is autorelease/scripts/release_notes_management/projects/release_notes.rst.
