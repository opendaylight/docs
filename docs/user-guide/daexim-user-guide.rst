...
* Method: POST
* <controller-ip> : Change <controller-ip> to the name of the host or IP address on which OpenDaylight is running.


The files created by export are placed in a subdirectory called *daexim*
in the installation directory of OpenDaylight. Similarly files needed for import should be placed in the *daexim* subdirectory.
