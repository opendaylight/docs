...
The *add-user* command allows for adding an OpenDaylight user. Some parameters
can be specified as her *role*, his *email* or the *domain* she belong to.
...
The *get-users* command list all the available users within the controller. The
system asks for the administrator credentials to execute this command.
...
The *get-roles* command list all the available roles within the controller. The
system asks for the administrator credentials to execute this command.
...
needs the role name as parameter.
...
The *remove-grant* command allows for removing an OpenDaylight grant. The command
needs the user name, her domain and her role as parameters.
...
on the generated OpenDaylight keystore and print it on the Karaf CLI. It asks
...
Karaf CLI. It asks for the keystore password.
