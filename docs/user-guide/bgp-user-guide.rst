...
.. code-block:: xml
   ...
   <bgp-peer-acceptor-config xmlns="urn:opendaylight:params:xml:ns:yang:controller:config">
       <config-name xmlns="urn:opendaylight:params:xml:ns:yang:odl-bgp-peer-acceptor-config">default</config-name>
       <binding-address xmlns="urn:opendaylight:params:xml:ns:yang:odl-bgp-peer-acceptor-config">0.0.0.0</binding-address>
       <binding-port xmlns="urn:opendaylight:params:xml:ns:yang:odl-bgp-peer-acceptor-config">1791</binding-port>
