...
Operational State
-----------------
Provides Operational state of BGP. Current information is updated every 5 seconds by default.
This period of time can be updated.
...
@line 1: List of families supported.

@line 2: Operational state per specific family.

@line 3: Family Identifier.

@line 4: Total number of Paths installed on RIB (Loc-RIB) per specific family.

@line 5: Total number of Prefixes installed on RIB (Loc-RIB) per specific family.
...
@line 1: List of neighbors.

@line 2: Operational state per specific neighbor.

@line 3: IP address of the remote BGP peer. Also serves as an unique identifier of a neighbor in a list of neighbors.

@line 4: Neighbor Operational State

BGP Neighbor Operational State
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. note:: Only provided when session has been established.
...
@line 5-6: BGP capabilities supported ( ASN32 / MPBGP / ROUTE_REFRESH / GRACEFUL_RESTART / ADD_PATHS)

@line 9: Total count of Update Messages sent

@line 10: Total count of Notification Messages sent
...
@line 8: True if family is advertized by peer.

@line 9: True if family is advertized to the peer.
...
@line 6: Total count of prefixes advertized by peer and installed.

@line 7: Total count of prefixes advertized to peer.

@line 8: Total count of prefixes advertized by peer.
...
@line 3: The negotiated hold-time for the BGP session.

@line 4: Time in milliseconds for how long session has been established.
...
.. note:: State is only provided once session is established.
.. note:: Error handling not supported yet. Planned to be implemented in Carbon.
...
.. note:: BGP Peer Group not supported yet. Planned to be implemented in Carbon.
...
@line 1: List of peer groups.

@line 2: Operational state per specific peer group.

@line 3: Peer Group Identifier.
@line 5: Same information than total prefixes. At this moment the cost for count path under effect-rib-in is to high.

@line 6: Total Prefixes installed under Effective-Rib-In by peers pertaining to this peer group. This count doesn't
 differentiate repeated prefixes.
