...
When installing BGP an example will be provided for illustration purposes but it's contents are commented out.
Uncomment/update it as per your usage requirements before use.
