...
intersphinx_mapping['genius'] = ('https://docs.opendaylight.org/projects/genius/en/stable-silicon/', None)
...
intersphinx_mapping['netvirt'] = ('https://docs.opendaylight.org/projects/netvirt/en/stable-silicon/', None)
