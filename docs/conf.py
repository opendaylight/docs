...
intersphinx_mapping['aaa'] = ('https://docs.opendaylight.org/projects/aaa/en/v0.14.8/', None)
# should be v0.14.10 but this version is not listed as available in RTD
intersphinx_mapping['bgpcep'] = ('https://docs.opendaylight.org/projects/bgpcep/en/v0.16.13/', None)
# should be v0.16.14 but this version is not listed as available in RTD
intersphinx_mapping['controller'] = ('https://docs.opendaylight.org/projects/controller/en/v4.0.3/', None)
# should be v4.0.10
intersphinx_mapping['infrautils'] = ('https://docs.opendaylight.org/projects/infrautils/en/v2.0.6/', None)
# should be v2.0.13
intersphinx_mapping['mdsal'] = ('https://docs.opendaylight.org/projects/mdsal/en/v8.0.5/', None)
# should be v8.0.11
intersphinx_mapping['netconf'] = ('https://docs.opendaylight.org/projects/netconf/en/v2.0.12/', None)
# should be v2.0.14
