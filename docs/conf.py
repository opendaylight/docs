...
intersphinx_mapping['odl-manganese'] = ('https://docs.opendaylight.org/en/latest/', None)
intersphinx_mapping['odl-chromium'] = ('https://docs.opendaylight.org/en/stable-chromium/', None)
