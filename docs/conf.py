...
intersphinx_mapping['aaa'] = ('https://docs.opendaylight.org/projects/aaa/en/stable-phosphorus/', None)
intersphinx_mapping['controller'] = ('https://docs.opendaylight.org/projects/controller/en/stable-phosphorus/', None)
intersphinx_mapping['infrautils'] = ('https://docs.opendaylight.org/projects/infrautils/en/stable-phosphorus/', None)
intersphinx_mapping['mdsal'] = ('https://docs.opendaylight.org/projects/mdsal/en/stable-phosphorus/', None)
intersphinx_mapping['netconf'] = ('https://docs.opendaylight.org/projects/netconf/en/stable-phosphorus/', None)
intersphinx_mapping['odl-integration-test'] = ('https://docs.opendaylight.org/projects/integration-test/en/stable-phosphorus/', None)
intersphinx_mapping['odl-integration-packaging'] = ('https://docs.opendaylight.org/projects/integration-packaging/en/stable-phosphorus/', None)
intersphinx_mapping['odl-releng-builder'] = ('https://docs.opendaylight.org/projects/releng-builder/en/stable-phosphorus/', None)
intersphinx_mapping['opflex'] = ('https://docs.opendaylight.org/projects/opflex/en/stable-phosphorus/', None)

# Projects that have stable/branches
intersphinx_mapping['bgpcep'] = ('https://docs.opendaylight.org/projects/bgpcep/en/stable-phosphorus/', None)
