...
* `odlparent <https://javadocs.opendaylight.org/odlparent/carbon>`_
* `openflowplugin <https://javadocs.opendaylight.org/openflowplugin/carbon>`_
* `ovsdb <https://javadocs.opendaylight.org/ovsdb/carbon>`_
* `p4plugin <https://javadocs.opendaylight.org/p4plugin/carbon>`_
* `sfc <https://javadocs.opendaylight.org/sfc/carbon>`_
* `yangtools <https://javadocs.opendaylight.org/yangtools/carbon>`_
