...
#. Copy the certificate and private key to the karaf's etc/tls folder
...
#. Configure the Netty server to use the certificate and private key in running karaf
...
#. Access the RESTCONF API using HTTPS
