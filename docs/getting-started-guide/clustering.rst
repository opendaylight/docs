...
#. Restart bundle via command line::
      ...
      pendaylight-user@root>restart org.opendaylight.controller.sal-distributed-datastore
...
``jolokia`` Karaf feature. This is convenient, due to a significant focus
