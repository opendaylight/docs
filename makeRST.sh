#!/bin/bash
#This script compiles documenatation from asciidoc source by converting asciidoc to reStructedText automatically using asciidoctor maven plug in and pandoc(http://www.pandoc.org/). 
#Please make sure you have pandoc(http://www.pandoc.org/) and sphinx(http://www.sphinx-doc.org/) installed.  
